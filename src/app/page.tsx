  ...
  return (
    <div className="dark min-h-screen flex items-center justify-center bg-gradient-to-br from-[#05030f] via-[#0e0520] to-[#000000] text-white relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 p-8 text-center relative z-10">
        <div>
          <h1 className="text-5xl font-light font-orbitron text-center mb-8 tracking-wide pl-[0.025em]">WorldBuilder:Zero</h1>
        </div>
        <div className="space-y-3">
          ...
          <Button asChild variant="outline" className="w-full opacity-75 hover:opacity-100 transition-opacity duration-500 border-purple-700 bg-purple-950/50 text-purple-100 hover:bg-purple-900/60 hover:text-white">
